...
--  Write the necessary SQL statements to do this and to populate the table with data. Assume Album Name,
--  Genre, and Label can hold strings up to 100 characters. Include an auto-incrementing id column in the albums table.
