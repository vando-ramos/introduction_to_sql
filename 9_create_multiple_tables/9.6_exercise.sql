...
-- the second consists of a Double Deluxe Burger, a Cheeseburger, two sets of Fries, Onion Rings,
-- a Chocolate Shake and a Vanilla Shake, and has a status of 'Complete'.
